...
config.JobType.psetName = 'QCD_0T_TuneCUETP8M1_cfi_GEN_SIM__PTMINFLAG_.py'
...
config.Data.outputDatasetTag = 'Pythia8_Dijet_0T_pthat_PTMINFLAG__pp_TuneCUETP8M1_Hydjet_MinBias_5020GeV_PrivMC'
