...
config.JobType.psetName = 'QCD_Pt_0T_5p02TeV_TuneCUETP8M1_cfi_GEN_SIM__PTMINFLAG_.py'
...
config.Data.outputDatasetTag = 'Pythia8_Dijet_0T_pthat_PTMINFLAG__pp_TuneCUETP8M1_5020GeV_PrivMC'
